...
namespace LMSService.Validators
{
    public class ReserveValidation : AbstractValidator<ReserveForCreationDto>
    {
        ...
        private readonly int maxCheckoutCount = 5;
        ...
        public ReserveValidation()
        {
            ...
            RuleFor(c => c.CurrentReserveCount).LessThanOrEqualTo(maxCheckoutCount).WithMessage("This member has reached the max amount of current checkouts");
        }
    }
}
